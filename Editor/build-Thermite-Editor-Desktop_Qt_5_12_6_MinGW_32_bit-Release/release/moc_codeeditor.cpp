...
#include "../../Project Thermite/src/codeeditor.h"
...
QT_MOC_LITERAL(1, 11, 19), // "placeLineNumberArea"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 20), // "updateLineNumberArea"
QT_MOC_LITERAL(4, 53, 21), // "updateAssociationList"
QT_MOC_LITERAL(5, 75, 22) // "displayAssociationList"

    },
    "CodeEditor\0placeLineNumberArea\0\0"
    "updateLineNumberArea\0updateAssociationList\0"
    "displayAssociationList"
};
...
void CodeEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->placeLineNumberArea(); break;
        case 1: _t->updateLineNumberArea((*reinterpret_cast< const QRect(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->updateAssociationList(); break;
        case 3: _t->displayAssociationList(); break;
        default: ;
        }
    }
}
